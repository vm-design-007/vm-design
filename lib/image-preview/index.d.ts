...
import type { ImagePreviewOnImgMousewheelInterface, ImagePreviewSwitchImageInterface, ImagePreviewOptionClickInterface } from './src/interface';
import type { OrdinaryFunctionInterface, HandleEventInterface, ClassListInterface } from '../_interface';
import type { LooseRequired } from '@vue/shared';
import type { DefineComponent, PropType, ExtractPropTypes, Ref, ComputedRef, CSSProperties, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, VNode, RendererNode, RendererElement, Component, ComputedOptions, MethodOptions } from 'vue';
import ImagePreview from "./src/image-preview";
export declare const VImagePreview: DefineComponent<{
    readonly imgList: {
    ...
    onEnter: OrdinaryFunctionInterface;
    handleClose: HandleEventInterface;
    packingClose: HandleEventInterface;
    onImgMousewheel: ImagePreviewOnImgMousewheelInterface;
