...
import type { DrawerDirectionType, DrawerCallbackInterface, PopupDirectionType } from '..';
...
export declare const VDrawer: DefineComponent<{
    readonly visible: {
    ...
    closeDrawer: OrdinaryFunctionInterface;
    ...
    readonly close: DrawerCallbackInterface;
    ...
    readonly open: DrawerCallbackInterface;
    readonly openEnd: DrawerCallbackInterface;
    readonly closeEnd: DrawerCallbackInterface;
    readonly direction: DrawerDirectionType;
}>;
