...
import type { CalendarMowDataClassListInterface, CalendarOptionClickInterface, CalendarHandleClickInterface } from './src/interface';
import type { LooseRequired } from '@vue/shared';
import type { CalendarMemorandumType, CalendarEmitInterface, ButtonSizeType, ButtonTargetType, ButtonType, ButtonNativeType, TextType, TextDecorationType } from '..';
import type { DefineComponent, PropType, ExtractPropTypes, Ref, ComputedRef, CSSProperties, VNode, RendererNode, RendererElement, Component, ComputedOptions, MethodOptions, h, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps } from 'vue';
import Calendar from "./src/calendar";
export declare const VCalendar: DefineComponent<{
    readonly date: {
    ...
    mowDataClassList: CalendarMowDataClassListInterface;
    optionClick: CalendarOptionClickInterface;
    nowTime: ComputedRef<string>;
    handleClick: CalendarHandleClickInterface;
