...
import type { DefineComponent, PropType, ExtractPropTypes, ComputedRef, CSSProperties, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, Ref } from 'vue';
import Empty from "./src/empty";
export declare const VEmpty: DefineComponent<{
    readonly content: {
